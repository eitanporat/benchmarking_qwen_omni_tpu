...
convert_element_type.1.loop_header.dim.1:         ; preds = %convert_element_type.1.loop_exit.dim.2, %convert_element_type.1.loop_body.dim.0
  ...
  %3 = icmp uge i64 %convert_element_type.1.indvar.dim.1, 480
...
convert_element_type.1.loop_header.dim.2:         ; preds = %convert_element_type.1.loop_exit.dim.3, %convert_element_type.1.loop_body.dim.1
  ...
  %4 = icmp uge i64 %convert_element_type.1.indvar.dim.2, 3
...
convert_element_type.1.loop_header.dim.3:         ; preds = %convert_element_type.1.loop_body.dim.3, %convert_element_type.1.loop_body.dim.2
  %convert_element_type.1.indvar.dim.3 = load i64, ptr %convert_element_type.1.invar_address.dim.3, align 4
  %5 = icmp uge i64 %convert_element_type.1.indvar.dim.3, 3
...
convert_element_type.1.loop_body.dim.3:           ; preds = %convert_element_type.1.loop_header.dim.3
  %6 = getelementptr inbounds [480 x [480 x [3 x [3 x float]]]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1, i64 %convert_element_type.1.indvar.dim.2, i64 %convert_element_type.1.indvar.dim.3
  %7 = load float, ptr %6, align 4, !invariant.load !3, !noalias !7
  %8 = call bfloat @xla.fptrunc.f32.to.bf16(float %7)
  %9 = getelementptr inbounds [480 x [480 x [3 x [3 x bfloat]]]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1, i64 %convert_element_type.1.indvar.dim.2, i64 %convert_element_type.1.indvar.dim.3
  store bfloat %8, ptr %9, align 2, !alias.scope !7
...
convert_element_type.1.loop_exit.dim.3:           ; preds = %convert_element_type.1.loop_header.dim.3
  ...
  br label %convert_element_type.1.loop_header.dim.2, !llvm.loop !10
...
convert_element_type.1.loop_exit.dim.2:           ; preds = %convert_element_type.1.loop_header.dim.2
  ...
  br label %convert_element_type.1.loop_header.dim.1, !llvm.loop !12
...
convert_element_type.1.loop_exit.dim.1:           ; preds = %convert_element_type.1.loop_header.dim.1
  ...
  br label %convert_element_type.1.loop_header.dim.0, !llvm.loop !13
