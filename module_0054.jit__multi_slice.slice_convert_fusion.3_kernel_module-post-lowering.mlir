module @slice_convert_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.3_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 2654208 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 663552 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %22 = llvm.getelementptr inbounds %arg0[0, %21] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1327104 x bf16>
    %23 = llvm.load %22 invariant : !llvm.ptr -> bf16
    %24 = llvm.add %18, %19 overflow<nsw> : i64
    %25 = llvm.getelementptr inbounds %arg1[0, %24] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<331776 x bf16>
    llvm.store %23, %25 : bf16, !llvm.ptr
    %26 = llvm.add %19, %7 : i64
    llvm.br ^bb4(%26 : i64)
  ^bb6:  // pred: ^bb4
    %27 = llvm.add %13, %7 : i64
    llvm.br ^bb2(%27 : i64) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  ^bb7:  // pred: ^bb2
    llvm.br ^bb8
  ^bb8:  // 2 preds: ^bb0, ^bb7
    llvm.return
