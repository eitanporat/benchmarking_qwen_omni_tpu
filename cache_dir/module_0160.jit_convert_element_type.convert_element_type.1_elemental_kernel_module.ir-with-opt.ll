...
define noalias noundef ptr @convert_element_type.1_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %.not10 = icmp ult i64 %lo_dim_0, %up_dim_0
  br i1 %.not10, label %convert_element_type.1.loop_header.dim.1.preheader, label %return

convert_element_type.1.loop_header.dim.1.preheader: ; preds = %1, %convert_element_type.1.loop_exit.dim.1
  %convert_element_type.1.invar_address.dim.0.011 = phi i64 [ %invar.inc, %convert_element_type.1.loop_exit.dim.1 ], [ %lo_dim_0, %1 ]
  %.split = getelementptr inbounds [128 x [2048 x [768 x float]]], ptr %arg0, i64 0, i64 %convert_element_type.1.invar_address.dim.0.011
  %.split6 = getelementptr inbounds [128 x [2048 x [768 x bfloat]]], ptr %arg1, i64 0, i64 %convert_element_type.1.invar_address.dim.0.011
...
convert_element_type.1.loop_header.dim.2.preheader: ; preds = %convert_element_type.1.loop_header.dim.1.preheader, %convert_element_type.1.loop_exit.dim.2
  %convert_element_type.1.invar_address.dim.1.09 = phi i64 [ 0, %convert_element_type.1.loop_header.dim.1.preheader ], [ %invar.inc3, %convert_element_type.1.loop_exit.dim.2 ]
  %.split5 = getelementptr inbounds nuw [2048 x [768 x float]], ptr %.split, i64 0, i64 %convert_element_type.1.invar_address.dim.1.09
  %.split7 = getelementptr inbounds nuw [2048 x [768 x bfloat]], ptr %.split6, i64 0, i64 %convert_element_type.1.invar_address.dim.1.09
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %convert_element_type.1.loop_header.dim.2.preheader
  %index = phi i64 [ 0, %convert_element_type.1.loop_header.dim.2.preheader ], [ %index.next, %vector.body ]
  %2 = getelementptr inbounds nuw [768 x float], ptr %.split5, i64 0, i64 %index
  ...
  %wide.load14 = load <8 x float>, ptr %3, align 32, !invariant.load !3, !noalias !7
  %wide.load15 = load <8 x float>, ptr %4, align 64, !invariant.load !3, !noalias !7
  %wide.load16 = load <8 x float>, ptr %5, align 32, !invariant.load !3, !noalias !7
  ...
  %50 = getelementptr inbounds nuw [768 x bfloat], ptr %.split7, i64 0, i64 %index
  ...
  %54 = icmp eq i64 %index.next, 768
  br i1 %54, label %convert_element_type.1.loop_exit.dim.2, label %vector.body, !llvm.loop !10

convert_element_type.1.loop_exit.dim.2:           ; preds = %vector.body
  %invar.inc3 = add nuw nsw i64 %convert_element_type.1.invar_address.dim.1.09, 1
  %exitcond12 = icmp eq i64 %invar.inc3, 2048
  br i1 %exitcond12, label %convert_element_type.1.loop_exit.dim.1, label %convert_element_type.1.loop_header.dim.2.preheader, !llvm.loop !13

convert_element_type.1.loop_exit.dim.1:           ; preds = %convert_element_type.1.loop_exit.dim.2
  %invar.inc = add i64 %convert_element_type.1.invar_address.dim.0.011, 1
  %exitcond13.not = icmp eq i64 %invar.inc, %up_dim_0
  br i1 %exitcond13.not, label %return, label %convert_element_type.1.loop_header.dim.1.preheader, !llvm.loop !15
...
!6 = !{i64 402653184}
!7 = !{!8}
!8 = !{!"result slice: {index:1, offset:0, size:402653184}", !9}
