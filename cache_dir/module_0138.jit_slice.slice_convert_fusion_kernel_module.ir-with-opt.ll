...
vector.body:                                      ; preds = %vector.body, %.preheader
  ...
  %105 = add nuw nsw i64 %104, 9373696
  ...
  %116 = add nuw nsw i64 %115, 9373696
  ...
  %127 = add nuw nsw i64 %126, 9373696
  ...
  %138 = add nuw nsw i64 %137, 9373696
  ...
  %149 = add nuw nsw i64 %148, 9373696
  ...
  %160 = add nuw nsw i64 %159, 9373696
  ...
  %171 = add nuw nsw i64 %170, 9373696
  ...
  %182 = add nuw nsw i64 %181, 9373696
