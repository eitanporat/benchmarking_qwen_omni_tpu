...
13:                                               ; preds = %11
  ...
  %invariant.op6 = or disjoint i64 %14, 1024
...
vector.ph21:                                      ; preds = %13, %vector.ph21
  ...
  br i1 %exitcond12.not, label %slice_convert_fusion.2_wrapped.exit, label %vector.ph21, !llvm.loop !11

179:                                              ; preds = %1
  %180 = icmp eq i64 %9, 13
  br i1 %180, label %.preheader, label %slice_convert_fusion.2_wrapped.exit
...
.preheader:                                       ; preds = %179, %.preheader
  ...
  %185 = add nuw nsw i64 %184, 7828480
  ...
  %194 = add nuw nsw i64 %184, 7828544
  ...
  %204 = add nuw nsw i64 %184, 7828608
  ...
  %214 = add nuw nsw i64 %184, 7828672
  ...
  %224 = add nuw nsw i64 %184, 7828736
  ...
  %234 = add nuw nsw i64 %184, 7828800
  ...
  %244 = add nuw nsw i64 %184, 7828864
  ...
  %254 = add nuw nsw i64 %184, 7828928
  ...
  %264 = add nuw nsw i64 %184, 7828992
  ...
  %274 = add nuw nsw i64 %184, 7829056
  ...
  %284 = add nuw nsw i64 %184, 7829120
  ...
  %294 = add nuw nsw i64 %184, 7829184
  ...
  %304 = add nuw nsw i64 %184, 7829248
  ...
  %314 = add nuw nsw i64 %184, 7829312
  ...
  %324 = add nuw nsw i64 %184, 7829376
  ...
  %334 = add nuw nsw i64 %184, 7829440
  ...
  br i1 %exitcond9.not, label %slice_convert_fusion.2_wrapped.exit, label %.preheader, !llvm.loop !11

slice_convert_fusion.2_wrapped.exit:              ; preds = %.preheader, %vector.ph21, %11, %179
  ret ptr null
}
