module @slice_convert_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  ^bb6:  // pred: ^bb5
    ...
    %26 = llvm.getelementptr inbounds %arg0[0, %25] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<8388608 x bf16>
    %27 = llvm.load %26 invariant : !llvm.ptr -> bf16
    %28 = llvm.add %22, %23 overflow<nsw> : i64
    %29 = llvm.getelementptr inbounds %arg1[0, %28] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2097152 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %41 = llvm.getelementptr inbounds %arg0[0, %40] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<8388608 x bf16>
    %42 = llvm.load %41 invariant : !llvm.ptr -> bf16
    %43 = llvm.add %36, %37 overflow<nsw> : i64
    %44 = llvm.add %43, %0 overflow<nsw> : i64
    %45 = llvm.getelementptr inbounds %arg1[0, %44] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2097152 x bf16>
