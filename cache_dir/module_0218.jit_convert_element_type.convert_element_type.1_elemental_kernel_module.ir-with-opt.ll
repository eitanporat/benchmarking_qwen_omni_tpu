...
convert_element_type.1.loop_header.dim.1.preheader: ; preds = %1, %convert_element_type.1.loop_exit.dim.1
  ...
  %.split = getelementptr inbounds [2048 x [1280 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
  %.split4 = getelementptr inbounds [2048 x [1280 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
