...
convert_element_type.1.loop_header.dim.1.preheader: ; preds = %1, %convert_element_type.1.loop_exit.dim.1
  ...
  %.split = getelementptr inbounds [128 x [1536 x [2048 x float]]], ptr %arg0, i64 0, i64 %convert_element_type.1.invar_address.dim.0.011
  %.split6 = getelementptr inbounds [128 x [1536 x [2048 x bfloat]]], ptr %arg1, i64 0, i64 %convert_element_type.1.invar_address.dim.0.011
...
convert_element_type.1.loop_header.dim.2.preheader: ; preds = %convert_element_type.1.loop_header.dim.1.preheader, %convert_element_type.1.loop_exit.dim.2
  ...
  %.split5 = getelementptr inbounds nuw [1536 x [2048 x float]], ptr %.split, i64 0, i64 %convert_element_type.1.invar_address.dim.1.09
  %.split7 = getelementptr inbounds nuw [1536 x [2048 x bfloat]], ptr %.split6, i64 0, i64 %convert_element_type.1.invar_address.dim.1.09
...
vector.body:                                      ; preds = %vector.body, %convert_element_type.1.loop_header.dim.2.preheader
  ...
  %2 = getelementptr inbounds nuw [2048 x float], ptr %.split5, i64 0, i64 %index
  ...
  %50 = getelementptr inbounds nuw [2048 x bfloat], ptr %.split7, i64 0, i64 %index
  ...
  %54 = icmp eq i64 %index.next, 2048
...
convert_element_type.1.loop_exit.dim.2:           ; preds = %vector.body
  ...
  %exitcond12 = icmp eq i64 %invar.inc3, 1536
