...
middle.block28:                                   ; preds = %vector.body21
  ...
  br i1 %exitcond11.not, label %slice_convert_fusion.2_wrapped.exit, label %vector.ph20, !llvm.loop !14

100:                                              ; preds = %1
  %101 = icmp eq i64 %9, 13
  br i1 %101, label %.preheader, label %slice_convert_fusion.2_wrapped.exit
...
vector.body:                                      ; preds = %vector.body, %.preheader
  ...
  %105 = add nuw nsw i64 %104, 10280448
  ...
  %116 = add nuw nsw i64 %115, 10280448
  ...
  %127 = add nuw nsw i64 %126, 10280448
  ...
  %138 = add nuw nsw i64 %137, 10280448
  ...
  %149 = add nuw nsw i64 %148, 10280448
  ...
  %160 = add nuw nsw i64 %159, 10280448
  ...
  %171 = add nuw nsw i64 %170, 10280448
  ...
  %182 = add nuw nsw i64 %181, 10280448
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %exitcond8.not, label %slice_convert_fusion.2_wrapped.exit, label %.preheader, !llvm.loop !14

slice_convert_fusion.2_wrapped.exit:              ; preds = %middle.block, %middle.block28, %11, %100
  ret ptr null
}
