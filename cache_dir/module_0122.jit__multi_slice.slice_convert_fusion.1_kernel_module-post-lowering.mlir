module @slice_convert_fusion.1_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.1_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 18874368 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4718592 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(2201472 : index) : i64
    %1 = llvm.mlir.constant(8808192 : index) : i64
    %2 = llvm.mlir.constant(169344 : index) : i64
    %3 = llvm.mlir.constant(2304 : index) : i64
    %4 = llvm.mlir.constant(4608 : index) : i64
    %5 = llvm.mlir.constant(677376 : index) : i64
    %6 = llvm.mlir.constant(13 : index) : i64
    %7 = llvm.mlir.constant(137 : index) : i64
    %8 = llvm.mlir.constant(1152 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    %28 = llvm.getelementptr inbounds %arg0[0, %27] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<9437184 x bf16>
    %29 = llvm.load %28 invariant : !llvm.ptr -> bf16
    %30 = llvm.add %23, %24 overflow<nsw> : i64
    %31 = llvm.getelementptr inbounds %arg1[0, %30] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2359296 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %43 = llvm.getelementptr inbounds %arg0[0, %42] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<9437184 x bf16>
    %44 = llvm.load %43 invariant : !llvm.ptr -> bf16
    %45 = llvm.add %38, %39 overflow<nsw> : i64
    %46 = llvm.add %45, %0 overflow<nsw> : i64
    %47 = llvm.getelementptr inbounds %arg1[0, %46] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2359296 x bf16>
