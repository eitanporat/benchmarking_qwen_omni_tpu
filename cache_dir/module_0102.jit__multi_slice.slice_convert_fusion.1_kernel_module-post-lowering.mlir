module @slice_convert_fusion.1_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.1_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 42467328 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 10616832 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(4972032 : index) : i64
    %1 = llvm.mlir.constant(15588864 : index) : i64
    %2 = llvm.mlir.constant(10616832 : index) : i64
    %3 = llvm.mlir.constant(382464 : index) : i64
    %4 = llvm.mlir.constant(13 : index) : i64
    %5 = llvm.mlir.constant(73 : index) : i64
    %6 = llvm.mlir.constant(4608 : index) : i64
    %7 = llvm.mlir.constant(83 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    %23 = llvm.getelementptr inbounds %arg0[0, %22] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<21233664 x bf16>
    %24 = llvm.load %23 invariant : !llvm.ptr -> bf16
    %25 = llvm.getelementptr inbounds %arg1[0, %21] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<5308416 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %36 = llvm.getelementptr inbounds %arg0[0, %35] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<21233664 x bf16>
    %37 = llvm.load %36 invariant : !llvm.ptr -> bf16
    %38 = llvm.add %34, %0 overflow<nsw> : i64
    %39 = llvm.getelementptr inbounds %arg1[0, %38] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<5308416 x bf16>
