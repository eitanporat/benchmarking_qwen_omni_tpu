; ModuleID = '__compute_module_convert_elemental_kernel_module'
source_filename = "__compute_module_convert_elemental_kernel_module"
...
define ptr @convert_kernel(ptr %0) #0 {
  %convert.invar_address.dim.1 = alloca i64, align 8
  %convert.invar_address.dim.0 = alloca i64, align 8
  ...
  store i64 0, ptr %convert.invar_address.dim.0, align 4
  br label %convert.loop_header.dim.0

convert.loop_header.dim.0:                        ; preds = %convert.loop_exit.dim.1, %1
  %convert.indvar.dim.0 = load i64, ptr %convert.invar_address.dim.0, align 4
  %2 = icmp uge i64 %convert.indvar.dim.0, 4
  br i1 %2, label %convert.loop_exit.dim.0, label %convert.loop_body.dim.0

convert.loop_body.dim.0:                          ; preds = %convert.loop_header.dim.0
  store i64 0, ptr %convert.invar_address.dim.1, align 4
  br label %convert.loop_header.dim.1

convert.loop_header.dim.1:                        ; preds = %convert.loop_body.dim.1, %convert.loop_body.dim.0
  %convert.indvar.dim.1 = load i64, ptr %convert.invar_address.dim.1, align 4
  %3 = icmp uge i64 %convert.indvar.dim.1, 288
  br i1 %3, label %convert.loop_exit.dim.1, label %convert.loop_body.dim.1

convert.loop_body.dim.1:                          ; preds = %convert.loop_header.dim.1
  %4 = getelementptr inbounds [4 x [288 x bfloat]], ptr %arg0, i64 0, i64 %convert.indvar.dim.0, i64 %convert.indvar.dim.1
  %5 = load bfloat, ptr %4, align 2, !invariant.load !3, !noalias !7
  %6 = bitcast bfloat %5 to i16
  %7 = zext i16 %6 to i32
  %8 = shl i32 %7, 16
  %9 = bitcast i32 %8 to float
  %10 = getelementptr inbounds [4 x [288 x float]], ptr %arg1, i64 0, i64 %convert.indvar.dim.0, i64 %convert.indvar.dim.1
  store float %9, ptr %10, align 4, !alias.scope !7
  %invar.inc3 = add nuw nsw i64 %convert.indvar.dim.1, 1
  store i64 %invar.inc3, ptr %convert.invar_address.dim.1, align 4
  br label %convert.loop_header.dim.1

convert.loop_exit.dim.1:                          ; preds = %convert.loop_header.dim.1
  %invar.inc = add nuw nsw i64 %convert.indvar.dim.0, 1
  store i64 %invar.inc, ptr %convert.invar_address.dim.0, align 4
  br label %convert.loop_header.dim.0, !llvm.loop !10

convert.loop_exit.dim.0:                          ; preds = %convert.loop_header.dim.0
  br label %return

return:                                           ; preds = %convert.loop_exit.dim.0
  ret ptr null
}
...
!6 = !{i64 4608}
!7 = !{!8}
!8 = !{!"result slice: {index:0, offset:0, size:4608}", !9}
!9 = !{!"XLA host kernel convert_kernel AA domain"}
!10 = distinct !{!10, !11}
