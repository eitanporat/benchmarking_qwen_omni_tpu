...
define ptr @convert_element_type.1_kernel(ptr %0) #0 {
  ...
  store i64 0, ptr %convert_element_type.1.invar_address.dim.0, align 4
...
convert_element_type.1.loop_header.dim.0:         ; preds = %convert_element_type.1.loop_exit.dim.1, %1
  ...
  %2 = icmp uge i64 %convert_element_type.1.indvar.dim.0, 480
...
convert_element_type.1.loop_header.dim.1:         ; preds = %convert_element_type.1.loop_exit.dim.2, %convert_element_type.1.loop_body.dim.0
  ...
  %3 = icmp uge i64 %convert_element_type.1.indvar.dim.1, 1
...
convert_element_type.1.loop_body.dim.3:           ; preds = %convert_element_type.1.loop_header.dim.3
  %6 = getelementptr inbounds [480 x [1 x [3 x [3 x float]]]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 0, i64 %convert_element_type.1.indvar.dim.2, i64 %convert_element_type.1.indvar.dim.3
  %7 = load float, ptr %6, align 4, !invariant.load !3, !noalias !7
  %8 = call bfloat @xla.fptrunc.f32.to.bf16(float %7)
  %9 = getelementptr inbounds [480 x [1 x [3 x [3 x bfloat]]]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 0, i64 %convert_element_type.1.indvar.dim.2, i64 %convert_element_type.1.indvar.dim.3
...
!6 = !{i64 8640}
!7 = !{!8}
!8 = !{!"result slice: {index:1, offset:0, size:8640}", !9}
