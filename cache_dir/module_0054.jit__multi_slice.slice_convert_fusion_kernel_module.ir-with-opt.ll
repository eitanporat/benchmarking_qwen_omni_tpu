...
define noalias noundef ptr @slice_convert_fusion(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  br i1 %10, label %11, label %slice_convert_fusion_wrapped.exit

11:                                               ; preds = %1
  %12 = mul nuw nsw i64 %9, 110592
  %13 = mul nuw nsw i64 %9, 27648
  %14 = or disjoint i64 %12, 864
  br label %iter.check
...
iter.check:                                       ; preds = %11, %iter.check
  ...
  br i1 %exitcond4.not, label %slice_convert_fusion_wrapped.exit, label %iter.check, !llvm.loop !11

slice_convert_fusion_wrapped.exit:                ; preds = %iter.check, %1
  ret ptr null
}
