...
109:                                              ; preds = %middle.block34
  ...
  br i1 %exitcond15.not, label %slice_convert_fusion.2_wrapped.exit, label %17, !llvm.loop !14

111:                                              ; preds = %1
  %112 = mul nuw nsw i64 %9, 10
  %113 = mul nuw nsw i64 %9, 31457280
  %114 = mul nuw nsw i64 %9, 7864320
  %115 = or disjoint i64 %113, 786432
  br label %116
...
.loopexit:                                        ; preds = %middle.block, %116
  ...
  br i1 %exitcond11.not, label %slice_convert_fusion.2_wrapped.exit, label %116, !llvm.loop !14

slice_convert_fusion.2_wrapped.exit:              ; preds = %.loopexit, %109, %11
  ret ptr null
}
