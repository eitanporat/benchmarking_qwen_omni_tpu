...
define internal void @slice_convert_fusion.3_wrapped(ptr noalias align 64 dereferenceable(8608) %0, ptr noalias align 64 dereferenceable(2152) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6

6:                                                ; preds = %9, %5
  %7 = phi i64 [ %13, %9 ], [ 0, %5 ]
  %8 = icmp slt i64 %7, 1076
  br i1 %8, label %9, label %14

9:                                                ; preds = %6
  %10 = getelementptr inbounds [4304 x bfloat], ptr %0, i32 0, i64 %7
  %11 = load bfloat, ptr %10, align 2, !invariant.load !3
  %12 = getelementptr inbounds [1076 x bfloat], ptr %1, i32 0, i64 %7
  store bfloat %11, ptr %12, align 2
  %13 = add i64 %7, 1
  br label %6
