...
module @jit_concatenate attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<4x288xbf16> loc("args[0]"), %arg1: tensor<4x288xbf16> loc("args[1]"), %arg2: tensor<4x288xbf16> loc("args[2]")) -> (tensor<4x864xbf16> {jax.result_info = "result"}) {
    %0 = stablehlo.concatenate %arg0, %arg1, %arg2, dim = 1 : (tensor<4x288xbf16>, tensor<4x288xbf16>, tensor<4x288xbf16>) -> tensor<4x864xbf16> loc(#loc33)
    return %0 : tensor<4x864xbf16> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
...
#loc6 = loc("/home/eporat/benchmarking_qwen_omni_tpu/.venv/lib/python3.11/site-packages/tpu_inference/layers/vllm/quantization/unquantized.py":93:19 to 100:13)
