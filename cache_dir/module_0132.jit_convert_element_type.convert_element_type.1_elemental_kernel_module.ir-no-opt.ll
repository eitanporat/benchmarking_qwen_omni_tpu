...
@convert_element_type.1_parallel_bounds = private constant [14 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 365]], [1 x [2 x i64]] [[2 x i64] [i64 365, i64 730]], [1 x [2 x i64]] [[2 x i64] [i64 730, i64 1095]], [1 x [2 x i64]] [[2 x i64] [i64 1095, i64 1460]], [1 x [2 x i64]] [[2 x i64] [i64 1460, i64 1825]], [1 x [2 x i64]] [[2 x i64] [i64 1825, i64 2190]], [1 x [2 x i64]] [[2 x i64] [i64 2190, i64 2555]], [1 x [2 x i64]] [[2 x i64] [i64 2555, i64 2920]], [1 x [2 x i64]] [[2 x i64] [i64 2920, i64 3285]], [1 x [2 x i64]] [[2 x i64] [i64 3285, i64 3650]], [1 x [2 x i64]] [[2 x i64] [i64 3650, i64 4015]], [1 x [2 x i64]] [[2 x i64] [i64 4015, i64 4380]], [1 x [2 x i64]] [[2 x i64] [i64 4380, i64 4745]], [1 x [2 x i64]] [[2 x i64] [i64 4745, i64 5120]]]
...
convert_element_type.1.loop_header.dim.1:         ; preds = %convert_element_type.1.loop_body.dim.1, %convert_element_type.1.loop_body.dim.0
  ...
  %3 = icmp uge i64 %convert_element_type.1.indvar.dim.1, 2048
...
convert_element_type.1.loop_body.dim.1:           ; preds = %convert_element_type.1.loop_header.dim.1
  %4 = getelementptr inbounds [5120 x [2048 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
  %5 = load float, ptr %4, align 4, !invariant.load !3, !noalias !7
  %6 = call bfloat @xla.fptrunc.f32.to.bf16(float %5)
  %7 = getelementptr inbounds [5120 x [2048 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
...
!6 = !{i64 20971520}
!7 = !{!8}
!8 = !{!"result slice: {index:1, offset:0, size:20971520}", !9}
