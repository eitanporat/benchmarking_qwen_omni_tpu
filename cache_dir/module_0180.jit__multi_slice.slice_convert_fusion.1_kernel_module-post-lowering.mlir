module @slice_convert_fusion.1_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  llvm.func @slice_convert_fusion.1(%arg0: !llvm.ptr) -> !llvm.ptr attributes {frame_pointer = #llvm.framePointerKind<all>, passthrough = [["prefer-vector-width", "256"]], uwtable_kind = #llvm.uwtableKind<async>} {
    ...
    %6 = llvm.load %5 invariant dereferenceable<bytes = 201326592> : !llvm.ptr -> !llvm.ptr
  ...
  llvm.func internal @slice_convert_fusion.1_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 805306368 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 201326592 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(786432 : index) : i64
    %1 = llvm.mlir.constant(7864320 : index) : i64
    %2 = llvm.mlir.constant(1572864 : index) : i64
    %3 = llvm.mlir.constant(3145728 : index) : i64
    %4 = llvm.mlir.constant(31457280 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    %27 = llvm.mul %25, %8 overflow<nsw> : i64
    %28 = llvm.add %22, %27 overflow<nsw> : i64
    %29 = llvm.add %24, %27 overflow<nsw> : i64
    llvm.br ^bb7(%11 : i64)
  ^bb7(%30: i64):  // 2 preds: ^bb6, ^bb8
    %31 = llvm.icmp "slt" %30, %8 : i64
    llvm.cond_br %31, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    %32 = llvm.add %28, %30 overflow<nsw> : i64
    %33 = llvm.add %32, %2 overflow<nsw> : i64
    %34 = llvm.getelementptr inbounds %arg0[0, %33] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<402653184 x bf16>
    %35 = llvm.load %34 invariant : !llvm.ptr -> bf16
    %36 = llvm.add %29, %30 overflow<nsw> : i64
    %37 = llvm.getelementptr inbounds %arg1[0, %36] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<100663296 x bf16>
    llvm.store %35, %37 : bf16, !llvm.ptr
    %38 = llvm.add %30, %12 : i64
    llvm.br ^bb7(%38 : i64)
  ^bb9:  // pred: ^bb7
  ...
  ^bb18:  // pred: ^bb17
    %58 = llvm.mul %56, %8 overflow<nsw> : i64
    %59 = llvm.add %52, %58 overflow<nsw> : i64
    %60 = llvm.add %55, %58 overflow<nsw> : i64
    llvm.br ^bb19(%11 : i64)
  ^bb19(%61: i64):  // 2 preds: ^bb18, ^bb20
    %62 = llvm.icmp "slt" %61, %8 : i64
    llvm.cond_br %62, ^bb20, ^bb21
  ^bb20:  // pred: ^bb19
    %63 = llvm.add %59, %61 overflow<nsw> : i64
    %64 = llvm.add %63, %2 overflow<nsw> : i64
    %65 = llvm.getelementptr inbounds %arg0[0, %64] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<402653184 x bf16>
    %66 = llvm.load %65 invariant : !llvm.ptr -> bf16
    %67 = llvm.add %60, %61 overflow<nsw> : i64
    %68 = llvm.getelementptr inbounds %arg1[0, %67] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<100663296 x bf16>
