...
define noalias noundef ptr @convert_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  br label %convert.loop_header.dim.1.preheader

convert.loop_header.dim.1.preheader:              ; preds = %1, %convert.loop_header.dim.1.preheader
  %convert.invar_address.dim.0.06 = phi i64 [ 0, %1 ], [ %invar.inc, %convert.loop_header.dim.1.preheader ]
  %.split4 = getelementptr inbounds nuw [4 x [288 x float]], ptr %arg1, i64 0, i64 %convert.invar_address.dim.0.06
  %.split = getelementptr inbounds nuw [4 x [288 x bfloat]], ptr %arg0, i64 0, i64 %convert.invar_address.dim.0.06
  ...
  %invar.inc = add nuw nsw i64 %convert.invar_address.dim.0.06, 1
  %exitcond7 = icmp eq i64 %invar.inc, 4
  br i1 %exitcond7, label %return, label %convert.loop_header.dim.1.preheader, !llvm.loop !10

return:                                           ; preds = %convert.loop_header.dim.1.preheader
  ret ptr null
}
