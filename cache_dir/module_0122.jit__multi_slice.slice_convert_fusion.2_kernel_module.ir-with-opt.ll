...
201:                                              ; preds = %1
  ...
  br i1 %202, label %.preheader, label %slice_convert_fusion.2_wrapped.exit
...
.preheader:                                       ; preds = %201, %.preheader
  ...
  %207 = add nuw nsw i64 %206, 8807040
  ...
  %216 = add nuw nsw i64 %206, 8807104
  ...
  %226 = add nuw nsw i64 %206, 8807168
  ...
  %236 = add nuw nsw i64 %206, 8807232
  ...
  %246 = add nuw nsw i64 %206, 8807296
  ...
  %256 = add nuw nsw i64 %206, 8807360
  ...
  %266 = add nuw nsw i64 %206, 8807424
  ...
  %276 = add nuw nsw i64 %206, 8807488
  ...
  %286 = add nuw nsw i64 %206, 8807552
  ...
  %296 = add nuw nsw i64 %206, 8807616
  ...
  %306 = add nuw nsw i64 %206, 8807680
  ...
  %316 = add nuw nsw i64 %206, 8807744
  ...
  %326 = add nuw nsw i64 %206, 8807808
  ...
  %336 = add nuw nsw i64 %206, 8807872
  ...
  %346 = add nuw nsw i64 %206, 8807936
  ...
  %356 = add nuw nsw i64 %206, 8808000
  ...
  %366 = add nuw nsw i64 %206, 8808064
  ...
  %376 = add nuw nsw i64 %206, 8808128
...
slice_convert_fusion.2_wrapped.exit:              ; preds = %.preheader, %vector.ph20, %11, %201
  ret ptr null
}
