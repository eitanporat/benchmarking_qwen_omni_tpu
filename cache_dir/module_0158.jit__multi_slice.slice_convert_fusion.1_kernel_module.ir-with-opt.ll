...
13:                                               ; preds = %11
  ...
  %invariant.op6 = or disjoint i64 %14, 2048
...
vector.ph21:                                      ; preds = %13, %vector.ph21
  ...
  br i1 %exitcond12.not, label %slice_convert_fusion.1_wrapped.exit, label %vector.ph21, !llvm.loop !11

179:                                              ; preds = %1
  %180 = icmp eq i64 %9, 13
  br i1 %180, label %.preheader, label %slice_convert_fusion.1_wrapped.exit
...
.preheader:                                       ; preds = %179, %.preheader
  ...
  %185 = add nuw nsw i64 %184, 7829504
  ...
  %194 = add nuw nsw i64 %184, 7829568
  ...
  %204 = add nuw nsw i64 %184, 7829632
  ...
  %214 = add nuw nsw i64 %184, 7829696
  ...
  %224 = add nuw nsw i64 %184, 7829760
  ...
  %234 = add nuw nsw i64 %184, 7829824
  ...
  %244 = add nuw nsw i64 %184, 7829888
  ...
  %254 = add nuw nsw i64 %184, 7829952
  ...
  %264 = add nuw nsw i64 %184, 7830016
  ...
  %274 = add nuw nsw i64 %184, 7830080
  ...
  %284 = add nuw nsw i64 %184, 7830144
  ...
  %294 = add nuw nsw i64 %184, 7830208
  ...
  %304 = add nuw nsw i64 %184, 7830272
  ...
  %314 = add nuw nsw i64 %184, 7830336
  ...
  %324 = add nuw nsw i64 %184, 7830400
  ...
  %334 = add nuw nsw i64 %184, 7830464
  ...
  br i1 %exitcond9.not, label %slice_convert_fusion.1_wrapped.exit, label %.preheader, !llvm.loop !11

slice_convert_fusion.1_wrapped.exit:              ; preds = %.preheader, %vector.ph21, %11, %179
  ret ptr null
}
