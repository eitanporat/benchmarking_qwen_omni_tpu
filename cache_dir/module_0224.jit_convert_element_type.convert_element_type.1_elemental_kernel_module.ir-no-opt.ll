...
convert_element_type.1.loop_header.dim.0:         ; preds = %convert_element_type.1.loop_body.dim.0, %1
  ...
  %2 = icmp uge i64 %convert_element_type.1.indvar.dim.0, 128
...
convert_element_type.1.loop_body.dim.0:           ; preds = %convert_element_type.1.loop_header.dim.0
  %3 = getelementptr inbounds [128 x float], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0
  %4 = load float, ptr %3, align 4, !invariant.load !3, !noalias !7
  %5 = call bfloat @xla.fptrunc.f32.to.bf16(float %4)
  %6 = getelementptr inbounds [128 x bfloat], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0
