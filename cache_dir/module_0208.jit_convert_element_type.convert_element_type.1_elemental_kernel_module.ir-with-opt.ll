...
convert_element_type.1.loop_header.dim.1.preheader: ; preds = %1, %convert_element_type.1.loop_exit.dim.1
  ...
  %.split = getelementptr inbounds [1280 x [5120 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
  %.split4 = getelementptr inbounds [1280 x [5120 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
...
vector.body:                                      ; preds = %vector.body, %convert_element_type.1.loop_header.dim.1.preheader
  ...
  %2 = getelementptr inbounds nuw [5120 x float], ptr %.split, i64 0, i64 %index
  ...
  %50 = getelementptr inbounds nuw [5120 x bfloat], ptr %.split4, i64 0, i64 %index
  ...
  %54 = icmp eq i64 %index.next, 5120
