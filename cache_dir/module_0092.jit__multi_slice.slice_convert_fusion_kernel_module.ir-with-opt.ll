...
iter.check23:                                     ; preds = %13, %iter.check23
  ...
  br i1 %exitcond11.not, label %slice_convert_fusion_wrapped.exit, label %iter.check23, !llvm.loop !11

213:                                              ; preds = %1
  %214 = icmp eq i64 %9, 13
  br i1 %214, label %iter.check, label %slice_convert_fusion_wrapped.exit
...
iter.check:                                       ; preds = %213, %iter.check
  ...
  %219 = add nuw nsw i64 %216, 4647244
  ...
  %228 = add nuw nsw i64 %216, 4647308
  ...
  %238 = add nuw nsw i64 %216, 4647372
  ...
  %248 = add nuw nsw i64 %216, 4647436
  ...
  %258 = add nuw nsw i64 %216, 4647500
  ...
  %268 = add nuw nsw i64 %216, 4647564
  ...
  %278 = add nuw nsw i64 %216, 4647628
  ...
  %288 = add nuw nsw i64 %216, 4647692
  ...
  %298 = add nuw nsw i64 %216, 4647756
  ...
  %308 = add nuw nsw i64 %216, 4647820
  ...
  %318 = add nuw nsw i64 %216, 4647884
  ...
  %328 = add nuw nsw i64 %216, 4647948
  ...
  %338 = add nuw nsw i64 %216, 4648012
  ...
  %348 = add nuw nsw i64 %216, 4648076
  ...
  %358 = add nuw nsw i64 %216, 4648140
  ...
  %368 = add nuw nsw i64 %216, 4648204
  ...
  %378 = add nuw nsw i64 %216, 4648268
  ...
  %382 = add nuw nsw i64 %216, 4648284
  ...
  %386 = add nuw nsw i64 %216, 4648300
  ...
  %390 = add nuw nsw i64 %216, 4648316
  ...
  %395 = add nuw nsw i64 %216, 4648317
  ...
  %400 = add nuw nsw i64 %216, 4648318
  ...
  %405 = add nuw nsw i64 %216, 4648319
  ...
  br i1 %exitcond8.not, label %slice_convert_fusion_wrapped.exit, label %iter.check, !llvm.loop !11

slice_convert_fusion_wrapped.exit:                ; preds = %iter.check, %iter.check23, %11, %213
  ret ptr null
}
