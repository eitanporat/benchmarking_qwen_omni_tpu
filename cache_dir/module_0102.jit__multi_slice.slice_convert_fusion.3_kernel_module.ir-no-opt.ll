...
define internal void @slice_convert_fusion.3_wrapped(ptr noalias align 64 dereferenceable(42467328) %0, ptr noalias align 64 dereferenceable(10616832) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = icmp sle i64 %2, 12
...
21:                                               ; preds = %18
  ...
  %23 = getelementptr inbounds [21233664 x bfloat], ptr %0, i32 0, i64 %22
  %24 = load bfloat, ptr %23, align 2, !invariant.load !3
  %25 = getelementptr inbounds [5308416 x bfloat], ptr %1, i32 0, i64 %22
...
34:                                               ; preds = %49, %33
  ...
  %36 = icmp slt i64 %35, 73
  br i1 %36, label %37, label %29

37:                                               ; preds = %34
  %38 = mul nsw i64 %35, 4608
  br label %39

39:                                               ; preds = %42, %37
  %40 = phi i64 [ %48, %42 ], [ 0, %37 ]
  %41 = icmp slt i64 %40, 4608
  br i1 %41, label %42, label %49

42:                                               ; preds = %39
  %43 = add nsw i64 %38, %40
  %44 = add nsw i64 %43, 4972032
  %45 = getelementptr inbounds [21233664 x bfloat], ptr %0, i32 0, i64 %44
  %46 = load bfloat, ptr %45, align 2, !invariant.load !3
  %47 = getelementptr inbounds [5308416 x bfloat], ptr %1, i32 0, i64 %44
