...
iter.check23:                                     ; preds = %13, %iter.check23
  ...
  br i1 %exitcond11.not, label %slice_convert_fusion.1_wrapped.exit, label %iter.check23, !llvm.loop !11

213:                                              ; preds = %1
  %214 = icmp eq i64 %9, 13
  br i1 %214, label %iter.check, label %slice_convert_fusion.1_wrapped.exit
...
iter.check:                                       ; preds = %213, %iter.check
  ...
  %219 = add nuw nsw i64 %216, 4646168
  ...
  %228 = add nuw nsw i64 %216, 4646232
  ...
  %238 = add nuw nsw i64 %216, 4646296
  ...
  %248 = add nuw nsw i64 %216, 4646360
  ...
  %258 = add nuw nsw i64 %216, 4646424
  ...
  %268 = add nuw nsw i64 %216, 4646488
  ...
  %278 = add nuw nsw i64 %216, 4646552
  ...
  %288 = add nuw nsw i64 %216, 4646616
  ...
  %298 = add nuw nsw i64 %216, 4646680
  ...
  %308 = add nuw nsw i64 %216, 4646744
  ...
  %318 = add nuw nsw i64 %216, 4646808
  ...
  %328 = add nuw nsw i64 %216, 4646872
  ...
  %338 = add nuw nsw i64 %216, 4646936
  ...
  %348 = add nuw nsw i64 %216, 4647000
  ...
  %358 = add nuw nsw i64 %216, 4647064
  ...
  %368 = add nuw nsw i64 %216, 4647128
  ...
  %378 = add nuw nsw i64 %216, 4647192
  ...
  %382 = add nuw nsw i64 %216, 4647208
  ...
  %386 = add nuw nsw i64 %216, 4647224
  ...
  %390 = add nuw nsw i64 %216, 4647240
  ...
  %395 = add nuw nsw i64 %216, 4647241
  ...
  %400 = add nuw nsw i64 %216, 4647242
  ...
  %405 = add nuw nsw i64 %216, 4647243
  ...
  br i1 %exitcond8.not, label %slice_convert_fusion.1_wrapped.exit, label %iter.check, !llvm.loop !11

slice_convert_fusion.1_wrapped.exit:              ; preds = %iter.check, %iter.check23, %11, %213
  ret ptr null
}
