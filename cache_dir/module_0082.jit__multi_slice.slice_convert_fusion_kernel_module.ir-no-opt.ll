...
define internal void @slice_convert_fusion_wrapped(ptr noalias align 64 dereferenceable(8608) %0, ptr noalias align 64 dereferenceable(2152) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
