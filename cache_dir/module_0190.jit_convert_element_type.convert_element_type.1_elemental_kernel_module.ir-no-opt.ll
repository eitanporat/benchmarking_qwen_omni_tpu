...
@convert_element_type.1_parallel_bounds = private constant [6 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 21]], [1 x [2 x i64]] [[2 x i64] [i64 21, i64 42]], [1 x [2 x i64]] [[2 x i64] [i64 42, i64 63]], [1 x [2 x i64]] [[2 x i64] [i64 63, i64 84]], [1 x [2 x i64]] [[2 x i64] [i64 84, i64 105]], [1 x [2 x i64]] [[2 x i64] [i64 105, i64 128]]]
...
define ptr @convert_element_type.1_kernel(ptr %0) #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [6 x [1 x [2 x i64]]], ptr @convert_element_type.1_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 0
  %up_dim_0_gep = getelementptr inbounds [6 x [1 x [2 x i64]]], ptr @convert_element_type.1_parallel_bounds, i32 0, i64 %workgroup_id_x, i32 0, i32 1
...
convert_element_type.1.loop_body.dim.1:           ; preds = %convert_element_type.1.loop_header.dim.1
  %4 = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
  %5 = load float, ptr %4, align 4, !invariant.load !3, !noalias !7
  %6 = call bfloat @xla.fptrunc.f32.to.bf16(float %5)
  %7 = getelementptr inbounds [128 x [2048 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
