...
define internal void @slice_convert_fusion_wrapped(ptr noalias align 64 dereferenceable(20971520) %0, ptr noalias align 64 dereferenceable(5242880) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = icmp sle i64 %2, 12
