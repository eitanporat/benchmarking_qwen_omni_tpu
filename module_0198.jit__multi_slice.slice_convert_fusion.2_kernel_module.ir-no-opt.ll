...
define internal void @slice_convert_fusion.2_wrapped(ptr noalias align 64 dereferenceable(622854144) %0, ptr noalias align 64 dereferenceable(155713536) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = icmp sle i64 %2, 12
