...
define internal void @slice_convert_fusion.2_wrapped(ptr noalias align 64 dereferenceable(8608) %0, ptr noalias align 64 dereferenceable(2152) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
...
9:                                                ; preds = %6
  %10 = add nsw i64 %7, 1076
  %11 = getelementptr inbounds [4304 x bfloat], ptr %0, i32 0, i64 %10
  %12 = load bfloat, ptr %11, align 2, !invariant.load !3
  %13 = getelementptr inbounds [1076 x bfloat], ptr %1, i32 0, i64 %7
