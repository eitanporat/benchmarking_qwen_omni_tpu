...
57:                                               ; preds = %vector.ph26
  ...
  br i1 %exitcond15.not, label %slice_convert_fusion.2_wrapped.exit, label %17, !llvm.loop !11

59:                                               ; preds = %1
  %60 = mul nuw nsw i64 %9, 10
  %61 = mul nuw nsw i64 %9, 15728640
  %62 = mul nuw nsw i64 %9, 3932160
  %63 = or disjoint i64 %61, 192
  br label %64
...
.loopexit:                                        ; preds = %vector.ph, %64
  ...
  br i1 %exitcond11.not, label %slice_convert_fusion.2_wrapped.exit, label %64, !llvm.loop !11

slice_convert_fusion.2_wrapped.exit:              ; preds = %.loopexit, %57, %11
  ret ptr null
}
