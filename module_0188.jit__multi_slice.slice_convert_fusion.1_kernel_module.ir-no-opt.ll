...
define internal void @slice_convert_fusion.1_wrapped(ptr noalias align 64 dereferenceable(402653184) %0, ptr noalias align 64 dereferenceable(100663296) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = icmp sle i64 %2, 11
