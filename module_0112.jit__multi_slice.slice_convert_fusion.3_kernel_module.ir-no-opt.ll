...
define internal void @slice_convert_fusion.3_wrapped(ptr noalias align 64 dereferenceable(9216) %0, ptr noalias align 64 dereferenceable(2304) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
...
9:                                                ; preds = %6
  %10 = getelementptr inbounds [4608 x bfloat], ptr %0, i32 0, i64 %7
  %11 = load bfloat, ptr %10, align 2, !invariant.load !3
  %12 = getelementptr inbounds [1152 x bfloat], ptr %1, i32 0, i64 %7
