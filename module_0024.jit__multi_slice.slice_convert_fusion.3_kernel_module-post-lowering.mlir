module @slice_convert_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.3_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 7962624 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 1990656 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(928512 : index) : i64
    %1 = llvm.mlir.constant(71424 : index) : i64
    %2 = llvm.mlir.constant(13 : index) : i64
    %3 = llvm.mlir.constant(58 : index) : i64
    %4 = llvm.mlir.constant(1152 : index) : i64
    %5 = llvm.mlir.constant(62 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    %22 = llvm.getelementptr inbounds %arg1[0, %19] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<995328 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %35 = llvm.getelementptr inbounds %arg1[0, %32] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<995328 x bf16>
