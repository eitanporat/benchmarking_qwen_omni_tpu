...
define internal void @slice_convert_fusion_wrapped(ptr noalias align 64 dereferenceable(20971520) %0, ptr noalias align 64 dereferenceable(16777216) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = icmp sle i64 %2, 12
...
10:                                               ; preds = %7
  %11 = mul nsw i64 %2, 600064
  br label %12

12:                                               ; preds = %27, %10
  %13 = phi i64 [ %28, %27 ], [ 0, %10 ]
  %14 = icmp slt i64 %13, 293
...
21:                                               ; preds = %18
  ...
  %23 = getelementptr inbounds [10485760 x bfloat], ptr %0, i32 0, i64 %22
  %24 = load bfloat, ptr %23, align 2, !invariant.load !3
  %25 = getelementptr inbounds [8388608 x bfloat], ptr %1, i32 0, i64 %22
...
42:                                               ; preds = %39
  ...
  %44 = add nsw i64 %43, 7800832
  %45 = getelementptr inbounds [10485760 x bfloat], ptr %0, i32 0, i64 %44
  %46 = load bfloat, ptr %45, align 2, !invariant.load !3
  %47 = getelementptr inbounds [8388608 x bfloat], ptr %1, i32 0, i64 %44
