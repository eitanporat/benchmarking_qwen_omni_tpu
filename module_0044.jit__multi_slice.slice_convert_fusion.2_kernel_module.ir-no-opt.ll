...
define internal void @slice_convert_fusion.2_wrapped(ptr noalias align 64 dereferenceable(6912) %0, ptr noalias align 64 dereferenceable(1728) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
