module @slice_convert_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  ^bb2:  // pred: ^bb1
    %5 = llvm.add %3, %0 overflow<nsw> : i64
    %6 = llvm.getelementptr inbounds %arg0[0, %5] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<3456 x bf16>
    %7 = llvm.load %6 invariant : !llvm.ptr -> bf16
    %8 = llvm.getelementptr inbounds %arg1[0, %3] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1152 x bf16>
    llvm.store %7, %8 : bf16, !llvm.ptr
    %9 = llvm.add %3, %2 : i64
    llvm.br ^bb1(%9 : i64)
  ^bb3:  // pred: ^bb1
    llvm.return
