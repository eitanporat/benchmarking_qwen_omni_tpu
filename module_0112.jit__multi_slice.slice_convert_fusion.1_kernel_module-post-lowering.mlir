module @slice_convert_fusion.1_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.1_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 9216 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 2304 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(2304 : index) : i64
  ...
  ^bb2:  // pred: ^bb1
    ...
    %7 = llvm.getelementptr inbounds %arg0[0, %6] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<4608 x bf16>
    %8 = llvm.load %7 invariant : !llvm.ptr -> bf16
    %9 = llvm.getelementptr inbounds %arg1[0, %4] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1152 x bf16>
    llvm.store %8, %9 : bf16, !llvm.ptr
    %10 = llvm.add %4, %3 : i64
    llvm.br ^bb1(%10 : i64)
  ^bb3:  // pred: ^bb1
    llvm.return
