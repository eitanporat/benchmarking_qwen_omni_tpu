module @slice_convert_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 7962624 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 2654208 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    ...
    %1 = llvm.mlir.constant(3897216 : index) : i64
    %2 = llvm.mlir.constant(2654208 : index) : i64
    %3 = llvm.mlir.constant(95616 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    %25 = llvm.getelementptr inbounds %arg1[0, %21] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1327104 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %39 = llvm.getelementptr inbounds %arg1[0, %38] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<1327104 x bf16>
