...
define ptr @convert.1_kernel(ptr %0) #0 {
  %convert.1.invar_address.dim.1 = alloca i64, align 8
  %convert.1.invar_address.dim.0 = alloca i64, align 8
  ...
  store i64 0, ptr %convert.1.invar_address.dim.0, align 4
  br label %convert.1.loop_header.dim.0

convert.1.loop_header.dim.0:                      ; preds = %convert.1.loop_exit.dim.1, %1
  %convert.1.indvar.dim.0 = load i64, ptr %convert.1.invar_address.dim.0, align 4
  %2 = icmp uge i64 %convert.1.indvar.dim.0, 4
  br i1 %2, label %convert.1.loop_exit.dim.0, label %convert.1.loop_body.dim.0

convert.1.loop_body.dim.0:                        ; preds = %convert.1.loop_header.dim.0
  store i64 0, ptr %convert.1.invar_address.dim.1, align 4
  br label %convert.1.loop_header.dim.1

convert.1.loop_header.dim.1:                      ; preds = %convert.1.loop_body.dim.1, %convert.1.loop_body.dim.0
  %convert.1.indvar.dim.1 = load i64, ptr %convert.1.invar_address.dim.1, align 4
  %3 = icmp uge i64 %convert.1.indvar.dim.1, 288
  br i1 %3, label %convert.1.loop_exit.dim.1, label %convert.1.loop_body.dim.1

convert.1.loop_body.dim.1:                        ; preds = %convert.1.loop_header.dim.1
  %4 = getelementptr inbounds [4 x [288 x bfloat]], ptr %arg0, i64 0, i64 %convert.1.indvar.dim.0, i64 %convert.1.indvar.dim.1
  %5 = load bfloat, ptr %4, align 2, !invariant.load !3, !noalias !7
  %6 = bitcast bfloat %5 to i16
  %7 = zext i16 %6 to i32
  %8 = shl i32 %7, 16
  %9 = bitcast i32 %8 to float
  %10 = getelementptr inbounds [4 x [288 x float]], ptr %arg1, i64 0, i64 %convert.1.indvar.dim.0, i64 %convert.1.indvar.dim.1
  store float %9, ptr %10, align 4, !alias.scope !7
  %invar.inc3 = add nuw nsw i64 %convert.1.indvar.dim.1, 1
  store i64 %invar.inc3, ptr %convert.1.invar_address.dim.1, align 4
  br label %convert.1.loop_header.dim.1

convert.1.loop_exit.dim.1:                        ; preds = %convert.1.loop_header.dim.1
  %invar.inc = add nuw nsw i64 %convert.1.indvar.dim.0, 1
  store i64 %invar.inc, ptr %convert.1.invar_address.dim.0, align 4
  br label %convert.1.loop_header.dim.0, !llvm.loop !10

convert.1.loop_exit.dim.0:                        ; preds = %convert.1.loop_header.dim.0
  br label %return

return:                                           ; preds = %convert.1.loop_exit.dim.0
  ret ptr null
}
