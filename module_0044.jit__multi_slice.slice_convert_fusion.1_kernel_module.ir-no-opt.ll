...
define internal void @slice_convert_fusion.1_wrapped(ptr noalias align 64 dereferenceable(6912) %0, ptr noalias align 64 dereferenceable(1728) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
...
9:                                                ; preds = %6
  %10 = add nsw i64 %7, 1728
  %11 = getelementptr inbounds [3456 x bfloat], ptr %0, i32 0, i64 %10
  %12 = load bfloat, ptr %11, align 2, !invariant.load !3
  %13 = getelementptr inbounds [864 x bfloat], ptr %1, i32 0, i64 %7
