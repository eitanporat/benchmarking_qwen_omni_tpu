...
@convert_element_type.1_parallel_bounds = private unnamed_addr constant [6 x [1 x [2 x i64]]] [[1 x [2 x i64]] [[2 x i64] [i64 0, i64 21]], [1 x [2 x i64]] [[2 x i64] [i64 21, i64 42]], [1 x [2 x i64]] [[2 x i64] [i64 42, i64 63]], [1 x [2 x i64]] [[2 x i64] [i64 63, i64 84]], [1 x [2 x i64]] [[2 x i64] [i64 84, i64 105]], [1 x [2 x i64]] [[2 x i64] [i64 105, i64 128]]]
...
define noalias noundef ptr @convert_element_type.1_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [6 x [1 x [2 x i64]]], ptr @convert_element_type.1_parallel_bounds, i64 0, i64 %workgroup_id_x
  %up_dim_0_gep = getelementptr inbounds [6 x [1 x [2 x i64]]], ptr @convert_element_type.1_parallel_bounds, i64 0, i64 %workgroup_id_x, i64 0, i64 1
...
convert_element_type.1.loop_header.dim.1.preheader: ; preds = %1, %convert_element_type.1.loop_exit.dim.1
  ...
  %.split = getelementptr inbounds [128 x [2048 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
  %.split4 = getelementptr inbounds [128 x [2048 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.invar_address.dim.0.07
...
vector.body:                                      ; preds = %vector.body, %convert_element_type.1.loop_header.dim.1.preheader
  ...
  %2 = getelementptr inbounds nuw [2048 x float], ptr %.split, i64 0, i64 %index
  ...
  %50 = getelementptr inbounds nuw [2048 x bfloat], ptr %.split4, i64 0, i64 %index
...
!6 = !{i64 524288}
!7 = !{!8}
!8 = !{!"result slice: {index:1, offset:0, size:524288}", !9}
