...
convert_element_type.1.loop_header.dim.2:         ; preds = %convert_element_type.1.loop_body.dim.2, %convert_element_type.1.loop_body.dim.1
  ...
  %4 = icmp uge i64 %convert_element_type.1.indvar.dim.2, 768
...
convert_element_type.1.loop_body.dim.2:           ; preds = %convert_element_type.1.loop_header.dim.2
  %5 = getelementptr inbounds [128 x [2048 x [768 x float]]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1, i64 %convert_element_type.1.indvar.dim.2
  %6 = load float, ptr %5, align 4, !invariant.load !3, !noalias !7
  %7 = call bfloat @xla.fptrunc.f32.to.bf16(float %6)
  %8 = getelementptr inbounds [128 x [2048 x [768 x bfloat]]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1, i64 %convert_element_type.1.indvar.dim.2
