module @slice_convert_fusion.2_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @slice_convert_fusion.2_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 18874368 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4718592 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(2201472 : index) : i64
    %1 = llvm.mlir.constant(8807040 : index) : i64
  ...
  ^bb6:  // pred: ^bb5
    ...
    %27 = llvm.getelementptr inbounds %arg0[0, %26] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<9437184 x bf16>
    %28 = llvm.load %27 invariant : !llvm.ptr -> bf16
    %29 = llvm.add %22, %23 overflow<nsw> : i64
    %30 = llvm.getelementptr inbounds %arg1[0, %29] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2359296 x bf16>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %42 = llvm.getelementptr inbounds %arg0[0, %41] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<9437184 x bf16>
    %43 = llvm.load %42 invariant : !llvm.ptr -> bf16
    %44 = llvm.add %37, %38 overflow<nsw> : i64
    %45 = llvm.add %44, %0 overflow<nsw> : i64
    %46 = llvm.getelementptr inbounds %arg1[0, %45] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2359296 x bf16>
