...
convert_element_type.1.loop_body.dim.1:           ; preds = %convert_element_type.1.loop_header.dim.1
  %4 = getelementptr inbounds [1152 x [1152 x float]], ptr %arg0, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
  %5 = load float, ptr %4, align 4, !invariant.load !3, !noalias !7
  %6 = call bfloat @xla.fptrunc.f32.to.bf16(float %5)
  %7 = getelementptr inbounds [1152 x [1152 x bfloat]], ptr %arg1, i64 0, i64 %convert_element_type.1.indvar.dim.0, i64 %convert_element_type.1.indvar.dim.1
...
!6 = !{i64 2654208}
!7 = !{!8}
!8 = !{!"result slice: {index:1, offset:0, size:2654208}", !9}
